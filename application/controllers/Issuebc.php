...
class Issuebc extends CI_Controller
{
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Issuebc_model');
	}

	public function index(){
		$data['issuebc'] 		= $this->Issuebc_model->tampilIssue();
		$data['id_issue'] 	= $this->Issuebc_model->idIssue();
		$data['barang']		= $this->Issuebc_model->tampilBarang();
		$this->load->view('template/header');
		$this->load->view('issue/issuebackcharge', $data);
	...
	public function simpanIssue(){
		...
		$ttl = $hrg*$jml;
		$data = array(
			'id_bc'		=> $this->input->post('id_issue'),
			'id_brg'		=> $this->input->post('nm_brg'),
			'tgl_bc'		=> $this->input->post('tgl'),
			'jml_bc'		=> $this->input->post('jml'),
			'total_bc'	=> $ttl,
			'ket_bc'		=> $this->input->post('ket')
		);
		$this->Issuebc_model->addIssue($data,$hrg);
	...
	public function updateIssue(){
		...
		$this->Issuebc_model->ubahIssue($data,$hrg,$jlm);
	...
	public function deleteIssue(){
		...
		$this->Issuebc_model->hapusIssue($idi,$idb,$jml,$ttl);
