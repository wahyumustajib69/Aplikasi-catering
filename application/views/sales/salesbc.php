...
<div id="page-wrapper" >
	<div class="header"> 
        <h1 class="page-header">
            <i class="fa fa-money"></i> SALES BACKCHARGE
        </h1>
    ...
    <div id="page-inner" style="margin-top: -30px;"> 
        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-condensed" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php 
                                    $no = 1; 
                                    foreach($sales_bc as $row){
                                        
                                    
                                    ?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $row->id_sbc; ?></td>
                                        <td><?php echo $row->tgl_sbc; ?></td>
                                        <td class="text-right"><?php echo number_format($row->jml_sbc); ?></td>
                                        
                                        <td class="text-right"><?php echo number_format($row->ttl_ibc); ?></td>
                                        ...
                                        <td align="center">
                                            <a data-toggle="modal" data-target="#EditSales<?php echo $row->id_sbc; ?>" data-popup="tooltip" data-placement="top"  class="btn btn-xs btn-info" > <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-id="<?php echo $row->id_sbc; ?>"
                                            data-nama="<?php echo $row->id_sbc; ?>" data-toggle="modal" data-target="#HapusSales<?php echo $row->id_sbc; ?>" class="btn btn-xs btn-danger"><i class="fa fa-times-circle"></i> </a>
                                        </td>
                                    </tr>
                                <?php  } ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right"><?php foreach($t_sales as $t){echo number_format($t->sal);}  ?></td>
                                        <td class="text-right"><?php foreach($t_issue as $i){echo number_format($i->tis);}  ?></td>
                ...
                <!--  Modals Tambah-->
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>salesbc/simpanSales">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #333333; color: #ffffff;">
                                ...
                                <h4 class="modal-title" id="myModalLabel" id="judul"><i class="fa fa-money"></i> TAMBAH SALES BACKCHARGE</h4>
                            </div>
                            <div class="modal-body">
                                <div id="tampil-modal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="id_sales" value="<?php echo $id_bc; ?>" class="form-control" readonly required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="tis" class="form-control" required="">
                                                ...
                                                <option value="<?php echo $t->total; ?>"><?php echo $t->tgl_bc.' | Total = '.number_format($t->total); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                ...
                <!--Modal Edit-->
                <?php foreach ($sales_bc as $row){ ?>
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>salesbc/updateSales">
                <div class="modal fade" id="EditSales<?php echo $row->id_sbc; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #333333; color: #ffffff;">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times-circle"></i></button>
                                <h4 class="modal-title" id="myModalLabel" id="judul"><i class="fa fa-money"></i> UPDATE SALES BACKCHARGE</h4>
                            </div>
                            <div class="modal-body">
                                <div id="tampil-modal">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Id Sales</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="id_sales" value="<?php echo $row->id_sbc; ?>" class="form-control" readonly required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Tanggal Sales</label>
                                        <div class="col-sm-9">
                                            <input type="date" name="tgl" value="<?php echo $row->tgl_sbc; ?>" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Jumlah (Rp)</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="jml" class="form-control" placeholder="Jumlah Sales" required="" value="<?php echo $row->jml_sbc; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Tanggal Issue</label>
                                        <div class="col-sm-9">
                                            <input type="hidden" name="tis" class="form-control" placeholder="Jumlah Sales" required="" value="<?php echo $row->ttl_ibc; ?>">
                                            <select name="tis" class="form-control" required="">
                                                <option disabled="" selected="">-Pilih Tanggal Issue-</option>
                                                <?php foreach($total as $t): ?>
                                                <option value="<?php echo $t->total; ?>" <?php if($t->total==$row->ttl_ibc){echo 'selected';} ?>><?php echo $t->tgl_bc.' | Total = '.number_format($t->total); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                ...
                <!--Modal Hapus-->
                <?php foreach ($sales_bc as $row){ ?>
                <form method="post" action="<?php echo base_url(); ?>salesbc/deleteSales">
                <div class="modal fade" id="HapusSales<?php echo $row->id_sbc; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #333333; color: #ffffff;">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times-circle"></i></button>
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="id_sales" value="<?php echo $row->id_sbc; ?>">
                                <h4 class="alert alert-info">Apakah Anda Yakin akan menghapus data <label class="text-danger"><?php echo $row->id_sbc; ?></label> ?</h4>
                            </div>
                            <div class="modal-footer" style="background-color: #333333; color: #ffffff;">
